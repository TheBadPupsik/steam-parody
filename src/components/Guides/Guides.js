  ...
  return(
    <div className='app_com'>
        ...
        <div className='main_div_community'>
          ...
          <div className='t_big_card' id='first_card_for'>
            <div className='first_desc'>
                <div className='ava_plus_nickname'>
                  <div><img src='/pictures/kruta_ava.png' alt="picture"/><p>Юзернейм</p></div>
                  <p>25.02.2024</p>
                </div> 
            ...
            <div className='fourth_desc'>
                <img src='/pictures/potushomobil.png' alt="potushomobil" className='picture_com_help'/>
                <div className='picture_com_text'>
                  <p id='text_four_c'>Цікавий заголовок гайда?</p>
                  <p id='text_five_c'>Lorem ipsum dolor sit amet consectetur. Amet nulla in risus commodo in in. Massa risus aliquet ut justo mauris blandit massa dolor vulputate. Pretium sit ullamcorper cursus cursus amet quis duis. Eu non faucibus varius orci eleifend vitae. Arcu et etiam urna neque ut. </p>
                </div>
            </div>
