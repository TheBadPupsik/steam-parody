...
export function Forum()
{
  return(
     <div className='app_com'>
        ...
        <div className='first_card_forum' id='first_card_for'>
            ...
            <p id='text_seven_c'>Цікавий заголовок поста з картинкою та текстом</p>
            <p id='text_sevenplus_c'>Lorem ipsum dolor sit amet consectetur. Amet nulla in risus commodo in in. Massa risus aliquet ut justo mauris blandit massa dolor vulputate. Pretium sit ullamcorper cursus cursus amet quis duis. Eu non faucibus varius orci eleifend vitae. Arcu et etiam urna neque ut. </p>
            <img src='/pictures/cave.png' alt="cave"/>
          ...
          <div className='five_big_card'>
            ...
            <p id='text_fiveplus_c'>Цікавий заголовок поста з картинкою та текстом</p>
            <p id='text_fiveplus_text_c'>Lorem ipsum dolor sit amet consectetur. Amet nulla in risus commodo in in. Massa risus aliquet ut justo mauris blandit massa dolor vulputate. Pretium sit ullamcorper cursus cursus amet quis duis. Eu non faucibus varius orci eleifend vitae. Arcu et etiam urna neque ut. </p>
            <div className='third_desc'>
                <div className='third_desc_b1'><img src='/pictures/h1.png' alt="heart"/>2.5k</div>
                <div className='third_desc_b2'><img src='/pictures/c1.png' alt="comment"/>2.5k</div>
                <div className='third_desc_b2'><img src='/pictures/share.png' alt="share"/>Поділитись</div>
          ...
          <div className='five_big_card'>
            ...
            <div className='third_desc'>
                ...
                <div className='third_desc_b2'><img src='/pictures/share.png' alt="share"/>Поділитись</div>
                  ...
                  <div className='first_card_forum'>
            <div className='first_desc'>
                <div className='ava_plus_nickname'>
                  <div><img src='/pictures/kruta_ava.png' alt="ava"/><p>Юзернейм</p></div>
                  <p>25.02.2024</p>
